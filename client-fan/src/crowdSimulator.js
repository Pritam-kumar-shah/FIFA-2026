// Crowd simulator — runs client-side, simulates realistic gate occupancy
// In production this would be replaced by real IoT sensor feeds
...
export function simulateStep(gates) {
  return gates.map((gate) => {
    // Match-day pattern: gates fill up as kickoff approaches, drain after
